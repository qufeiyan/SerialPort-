...
{
    MadgwickAHRS(samplePeriod,1.0f);
}
...
float MadgwickAHRS::getSamplePeriod()
{
...
float MadgwickAHRS::getBeta()
{
    return this->beta;
}

float *MadgwickAHRS::getQuaternion()
{
...
void MadgwickAHRS::update(float gx, float gy, float gz, float ax, float ay, float az)
{
    ...
    s2 = _4q2 * q4q4 - _2q4 * ax + 4.0f * q1q1 * q2 - _2q1 * ay - _4q2 + _8q2
        * q2q2 + _8q2 * q3q3 + _4q2 * az;
    s3 = 4.0f * q1q1 * q3 + _2q1 * ax + _4q3 * q4q4 - _2q4 * ay - _4q3 + _8q3
        * q2q2 + _8q3 * q3q3 + _4q3 * az;
    s4 = 4.0f * q2q2 * q4 - _2q2 * ax + 4.0f * q3q3 * q4 - _2q3 * ay;
    norm = 1.0f / (float) sqrt(s1 * s1 + s2 * s2 + s3 * s3 + s4 * s4); // normalise
                                        // step
                                        // magnitude
    s1 *= norm;
    s2 *= norm;
    ...
    norm = 1.0f / (float) sqrt(q1 * q1 + q2 * q2 + q3 * q3 + q4 * q4); // normalise
                                        // quaternion
...
void MadgwickAHRS::update(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz)
{
    float q1 = quaternion[0], q2 = quaternion[1], q3 = quaternion[2], q4 = quaternion[3]; // short
        ...
        s2 = _2q4 * (2.0f * q2q4 - _2q1q3 - ax) + _2q1
            ...
            * (1 - 2.0f * q2q2 - 2.0f * q3q3 - az) + _2bz * q4
            * (_2bx * (0.5f - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mx)
            + (_2bx * q3 + _2bz * q1)
        ...
        s3 = -_2q1 * (2.0f * q2q4 - _2q1q3 - ax) + _2q4
            ...
            * (1 - 2.0f * q2q2 - 2.0f * q3q3 - az) + (-_4bx * q3 - _2bz * q1)
            * (_2bx * (0.5f - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mx)
            + (_2bx * q2 + _2bz * q4)
            * (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - my)
            + (_2bx * q1 - _4bz * q3)
        ...
        s4 = _2q2 * (2.0f * q2q4 - _2q1q3 - ax) + _2q3
            * (2.0f * q1q2 + _2q3q4 - ay) + (-_4bx * q4 + _2bz * q2)
            * (_2bx * (0.5f - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mx)
            + (-_2bx * q1 + _2bz * q3)
            * (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - my) + _2bx
            * q2
        ...
        norm = 1.0f / (float) sqrt(q1 * q1 + q2 * q2 + q3 * q3 + q4 * q4); // normalise
                                            // quaternion
        this->quaternion[0] = q1 * norm;
        this->quaternion[1] = q2 * norm;
        this->quaternion[2] = q3 * norm;
        this->quaternion[3] = q4 * norm;
}
